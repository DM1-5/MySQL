/***************************************/
/* ESTRUCTURA Y TABLAS PARA DREAMHOME */
/***************************************/
...
Insert INTO Staff (staffNo,fname,lname,position,sex,DOB,salary,branchNo)
            values('SL21','Jhon','White','Manager','M','1945-10-01',30000,'B005');
Insert INTO Staff (staffNo,fname,lname,position,sex,DOB,salary,branchNo)
...
insert into PropertyForRent (propertyNo, street, city, postcode, type, rooms, rent, ownerNo, staffNo, branchNo)
       Values ('PG21', '18 Dale Rd', 'Glasgow', 'G12', 'House', 3, 600, 'CO87', 'SG37', 'B003');	
insert into PropertyForRent (propertyNo, street, city, postcode, type, rooms, rent, ownerNo, staffNo, branchNo)
...
INSERT INTO Registration (clientNo, branchNo, staffNo, dateJoined)
	VALUES ('CR76', 'B005', 'SL41', '2004-01-04');
INSERT INTO Registration (clientNo, branchNo, staffNo, dateJoined)
...
Insert INTO Lease  (leaseNo, propertyNo, clientNo, rent, paymentMethod, deposit, paid, rentStart, rentFinish, duration) 
       values ('10024', 'PA14', 'CR62', 650, 'visa', 1300, 'Y', '2005-06-01', '2005-05-31', 12);
Insert INTO Lease  (leaseNo, propertyNo, clientNo, rent, paymentMethod, deposit, paid, rentStart, rentFinish, duration) 
       values ('10075', 'PL94', 'CR76', 400, 'cash', 800, 'N', '2005-06-01', '2005-01-31', 6);
Insert INTO Lease  (leaseNo, propertyNo, clientNo, rent, paymentMethod, deposit, paid, rentStart, rentFinish, duration) 
       values ('10012', 'PG21', 'CR74', 600, 'cheque', 1200, 'Y', '2005-07-01', '2005-06-30', 12);
/***********************************************************************************************/